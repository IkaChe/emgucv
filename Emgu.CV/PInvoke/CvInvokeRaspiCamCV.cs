...
namespace Emgu.CV
{
    ...
    public class CvInvokeRaspiCamCV
    {
...
#else
        public const string OpencvRaspiCamCVLibrary = "opencv_highgui300";
        ...
        [DllImport(OpencvRaspiCamCVLibrary, EntryPoint=EntryPointCapture, CallingConvention = CvInvoke.CvCallingConvention)]
        ...
        [DllImport(OpencvRaspiCamCVLibrary, EntryPoint=EntryPointQuery, CallingConvention = CvInvoke.CvCallingConvention)]
